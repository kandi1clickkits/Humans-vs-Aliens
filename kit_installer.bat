...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/Humans-vs-Aliens/releases/download/v1.0.0/Humans-vs-Aliens.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/Humans-vs-Aliens/raw/master/requirements.txt
SET REPO_NAME=Humans-vs-Aliens.zip
SET EXTRACTED_REPO_DIR=Humans-vs-Aliens
SET FILE_NAME=HumansAliens.py
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
